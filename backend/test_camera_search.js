...
import { parseImageFallback } from "./utils/aiHelper.js";
...
async function run() {
  try {
    const testFileName = "navy_blue_dress.jpg";
    console.log(`🔍 Testing Image Filename Fallback Parser for: "${testFileName}"`);
    const parsed = await parseImageFallback(testFileName, "image/jpeg");
